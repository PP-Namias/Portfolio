...
export const sectionMetadata: Record<string, SEOMetadata> = {
  ...
  gallery: {
    title: "Gallery - Certifications & Achievements",
    description:
      "Professional certifications, awards, and achievements in software development, data science, and technology. Certified in various technologies and frameworks.",
    keywords: [
      "certifications",
      "achievements",
      "awards",
