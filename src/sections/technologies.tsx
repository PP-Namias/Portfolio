...
import { TechStackSkeleton } from "@/components/ui/skeleton-loaders";
  ...
  return (
    <>
      <div className="relative overflow-x-hidden rounded-xl">
        <div className="from-background absolute left-0 z-5 flex h-full items-center bg-linear-to-r to-transparent px-6"></div>
        <div className="to-background absolute right-0 z-5 flex h-full items-center bg-linear-to-r from-transparent px-6">
          <Tooltip
            color="primary"
