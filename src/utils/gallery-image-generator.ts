...
export function generatePlaceholderSVG(placeholder: ImagePlaceholder): string {
  const { title, dimensions, primaryColor, secondaryColor, iconType } = placeholder;
 ...
 */
export function getProjectImageUrl(projectSlug: string, imageType: 'main' | 'detail' = 'main'): string {
