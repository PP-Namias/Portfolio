  ...
  projects: [
    {
      ...
      image: '',
      description: 'Production portfolio website with AI chat, Sanity CMS, and comprehensive testing',
      tags: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Sanity'],
      year: 2025,
      ...
      processURL: null,
      detailURL: 'https://namias.tech',
      status: 'completed',
      tier: 'featured',
      showcaseDetail: false,
      shortDescription: 'Production portfolio with AI chat, Sanity CMS, and 278 tests',
      highlights: ['278 tests with react-doctor 100/100 score', '19 CI/CD workflows'],
    ...
    },
    {
      ...
      image: '',
      description: 'AI-assisted Filipino health companion with document scan, multilingual chatbot, and facility discovery',
      tags: ['TypeScript', 'Expo', 'Next.js', 'tRPC', 'PostgreSQL'],
      year: 2026,
      ...
      tier: 'featured',
      showcaseDetail: true,
      shortDescription: 'AI-assisted Filipino health companion with document scan and chatbot',
      highlights: ['Multilingual support for Filipino dialects', 'Medical document scanning'],
      githubRepo: 'Klaro',
      slug: 'klaro',
    },
  ],
