...
export function TechStackSection() {
  ...
  return (
    ...
    >
      <h2 id="skills-heading" className="text-[11px] font-bold uppercase tracking-[0.14em] text-accent-pink border-b border-border-light dark:border-border-dark pb-2 mb-4 flex items-center gap-2">
        Skills
