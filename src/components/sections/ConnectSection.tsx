...
import { FaDiscord, FaFacebook, FaGithub, FaLinkedinIn, FaXTwitter } from 'react-icons/fa6'
  ...
  return (
    ...
    >
      ...
      <p className="text-[13px] sm:text-sm text-text-secondary-light dark:text-text-secondary-dark mb-2 leading-[1.7]">
        Open for collaborations, freelance work, and interesting conversations. Let&apos;s build
        something together.
      </p>
      ...
      <div className="flex flex-wrap items-center gap-2">
        {socialLinks
          .filter((link) => !['cal', 'email'].includes(link.name))
          .map((link, index) => {
