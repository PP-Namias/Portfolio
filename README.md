...
A static blog template built with [Astro](https://astro.build) with comprehensive CI/CD automation.
...
🌏 README in
[**中文**](https://github.com/PP-Namias/blob/main/docs/README.zh-CN.md) /
[**日本語**](https://github.com/PP-Namias/blob/main/docs/README.ja.md) /
[**한국어**](https://github.com/PP-Namias/blob/main/docs/README.ko.md) /
[**Español**](https://github.com/PP-Namias/blob/main/docs/README.es.md) /
[**ไทย**](https://github.com/PP-Namias/blob/main/docs/README.th.md) /
[**Tiếng Việt**](https://github.com/PP-Namias/blob/main/docs/README.vi.md) /
[**Bahasa Indonesia**](https://github.com/PP-Namias/blob/main/docs/README.id.md) (Provided by the community and may not always be up-to-date)
...
- [x] [Markdown extended features](https://github.com/PP-Namias?tab=readme-ov-file#-markdown-extended-syntax)
- [x] Table of contents
- [x] RSS feed
...
1. Create your blog repository:
    - [Generate a new repository](https://github.com/PP-Namias/generate) from this template or fork this repository.
...
Check out the [Contributing Guide](https://github.com/PP-Namias/blob/main/CONTRIBUTING.md) for details on how to contribute to this project.
