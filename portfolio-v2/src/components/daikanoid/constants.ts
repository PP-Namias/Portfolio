...
export const FONT_URL =
  "https://namias.tech/fonts/DepartureMono-Regular.otf"

export const SOUND_BOUNCE_URL =
  "https://namias.tech/sounds/daikanoid/bounce.mp3"
export const SOUND_BREAK_URL =
  "https://namias.tech/sounds/daikanoid/break.mp3"
export const SOUND_GAME_OVER_URL =
  "https://namias.tech/sounds/daikanoid/game-over.mp3"

export const BALL_LIGHT_URL =
  "https://namias.tech/images/daikanoid/ball-light.png?v=2"
export const BALL_DARK_URL =
  "https://namias.tech/images/daikanoid/ball-dark.png?v=2"

export const PADDLE_LIGHT_URL =
  "https://namias.tech/images/daikanoid/paddle-light.png?v=2"
export const PADDLE_DARK_URL =
  "https://namias.tech/images/daikanoid/paddle-dark.png?v=2"
