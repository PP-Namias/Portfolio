...
const components: MDXRemoteProps["components"] = {
  h1: (props) => <Heading as="h1" {...(props as React.ComponentProps<"h1">)} />,
  h2: (props) => <Heading as="h2" {...(props as React.ComponentProps<"h2">)} />,
  h3: (props) => <Heading as="h3" {...(props as React.ComponentProps<"h3">)} />,
  h4: (props) => <Heading as="h4" {...(props as React.ComponentProps<"h4">)} />,
  h5: (props) => <Heading as="h5" {...(props as React.ComponentProps<"h5">)} />,
  h6: (props) => <Heading as="h6" {...(props as React.ComponentProps<"h6">)} />,
  table: Table,
  thead: TableHeader,
  tbody: TableBody,
  tr: TableRow,
