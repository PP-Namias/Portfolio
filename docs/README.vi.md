...
[**🖥️ Xem bản dùng thử (Vercel)**](http://namias.tech)
...
- Chêm xen ([Xem trước và Cách sử dụng](http://namias.tech/posts/markdown-extended/#admonitions))
- Thẻ hiển thị kho lưu trữ GitHub ([Xem trước và Cách sử dụng](http://namias.tech/posts/markdown-extended/#github-repository-cards))
- Các khối mã nâng cao với Expressive Code ([Xem trước](http://namias.tech/posts/expressive-code/) / [Tài liệu](https://expressive-code.com/))
