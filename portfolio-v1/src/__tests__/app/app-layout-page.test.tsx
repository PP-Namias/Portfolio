...
vi.mock('@/components/sections/TechStackSection', () => ({
  TechStackSection: () => <div>TechStackSection</div>,
}))
vi.mock('@/components/sections/ProjectsSection', () => ({
  ProjectsSection: () => <div>ProjectsSection</div>,
}))
vi.mock('@/components/sections/ProjectsSectionRevamped', () => ({
  ProjectsSectionRevamped: () => <div>ProjectsSectionRevamped</div>,
}))
vi.mock('@/components/sections/CertificationsSection', () => ({
  CertificationsSection: () => <div>CertificationsSection</div>,
}))
vi.mock('@/components/sections/BlogSection', () => ({ BlogSection: () => <div>BlogSection</div> }))
vi.mock('@/components/sections/ExperienceTimeline', () => ({
  ExperienceTimeline: () => <div>ExperienceTimeline</div>,
}))
vi.mock('@/components/sections/ConnectSection', () => ({
  ConnectSection: () => <div>ConnectSection</div>,
}))
vi.mock('@/components/sections/GallerySection', () => ({
  GallerySection: () => <div>GallerySection</div>,
}))
vi.mock('@/components/sections/GitHubContributionsSection', () => ({
  GitHubContributionsSection: () => <div>GitHubContributionsSection</div>,
}))
